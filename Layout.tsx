...
import { LayoutDashboard, Users, Calendar, Wallet, Settings, LogOut, Search, Bell, Menu, X, Crown, ClipboardList } from 'lucide-react';
...
export const Layout: React.FC<LayoutProps> = ({ children, user, currentView, onNavigate, onLogout, lang }) => {
  ...
  const navItems = [
    ...
    // Only show Fees and Subscription for Owner
    ...(user.role === 'owner' ? [
      { 
        id: 'FEES', 
        view: 'FEES_VIEW', 
        ...
        <nav className="mt-8 space-y-1">
          {navItems.map(item => (
            <SidebarItem 
              ...
              onClick={() => {
                // Special handling for Subscription which triggers modal
           ...
           <div className="flex items-center gap-6">
              ...
              <div className="flex items-center gap-4">
                 ...
                 <div className="flex items-center gap-3 pl-4 border-l border-gray-100">
                    ...
                    <div className="w-10 h-10 rounded-full bg-[#1e293b] text-white flex items-center justify-center font-bold text-lg border-2 border-gray-100 shadow-sm">
